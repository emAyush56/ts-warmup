...
let arr: (number | string)[] = [1, 2, "Ayush", 44, "Prithish"]; // parentheses are important
let _arr: Array<number | string> = [1, 2, "Ayush", 44, "Prithish"]; // better way, i think
console.log(arr, _arr);

let arr2: number[] | string[] = ["1", "2", "Ayush", "44", "Prithish"]; // this means either arr has to be completely of type number or string
console.log(arr2);

// something new
let seatAllotedType: "aisle" | "middle" | "window";
